...
class Test_login_page(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.lg = LG(driver)
        self.lg.g_url(os.path.join(test_environment,"dbshop/user/login"))
